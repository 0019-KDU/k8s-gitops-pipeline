...
runs-on: ubuntu-latest
    ...
    steps:
      ...
      - name: Build Docker Image
        run: |
          docker build . -t chiradev/demo-app:${{ env.VERSION }}

      # Push the Docker Image
      - name: Push Docker Image
        run: |
          docker push chiradev/demo-app:${{ env.VERSION }}

      # UPdate the K8s Manifest Files
      - name: Update K8s Manifests
        run: |
          cat deploy/deploy.yaml
          sed -i "s|image: chiradev/demo-app:.*|image: chiradev/demo-app:${{ env.VERSION }}|g" deploy/deploy.yaml
          cat deploy/deploy.yaml
      ...
      - name: Commit the changes
        run: |
          ...
          git remote set-url origin https://github-actions:${{ secrets.GITHUB_TOKEN }}@github.com/0019-KDU/k8s-gitops-pipeline.git
...
- Select New App.
![alt text](docs/setting1.png)
![alt text](docs/setting2.png)

---

- Successfully Deployed our app:
![alt text](docs/git2.png)
